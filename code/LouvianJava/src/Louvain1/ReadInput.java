...
public class ReadInput {
    ...
    public static Graph readInputFile(String filename, String sp, int start) throws IOException{
        ...
        HashMap<Integer, Double>[] weightsEdge;
        double lineWeight;
        ...
        weightsEdge = (HashMap<Integer, Double>[]) new HashMap[nNodes];;
        ...
        while ((lineText = bufferedReader.readLine()) != null){
            ...
            if (node1 != node2){
                ...
                if (weightsEdge[node1] == null) {
                    weightsEdge[node1] = new HashMap<>();
                }
                if (weightsEdge[node2] == null) {
                    weightsEdge[node2] = new HashMap<>();
                }
                if (weightsEdge[node1].containsKey(node2)){
                    temp = weightsEdge[node1].get(node2);
                    lineWeight = temp + lineWeight;
                }
                weightsEdge[node1].put(node2, lineWeight);
                weightsEdge[node2].put(node1, lineWeight);
                if (adj[node1] == null)
...
//    }
    ...
    public static void writeFile(String filename, HashMap<Integer, Double>[] weightsEdge, int start) throws IOException{
        BufferedWriter bufferedWriter;
        int i, j;
